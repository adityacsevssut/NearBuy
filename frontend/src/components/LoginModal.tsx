  ...
  const GoogleBtn = () => (
    <div className="w-full mt-2 flex justify-center items-center">
      <button
        ...
        disabled={loading}
        className="w-full py-3.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-bold text-[14px] shadow-sm flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
      >

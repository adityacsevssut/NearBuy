        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-xl border text-sm font-semibold text-gray-900 dark:text-gray-100 bg-white dark:bg-[#151522] focus:outline-none transition-all ${
                customerMobile && !isMobileValid ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-gray-200 dark:border-[#2A2A3A] focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-xl border text-sm font-semibold text-gray-900 dark:text-gray-100 bg-white dark:bg-[#151522] focus:outline-none transition-all ${
                alternateMobile && !isAltMobileValid ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-100' : 'border-gray-200 dark:border-[#2A2A3A] focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
              }`}
            />

      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-sm bg-white dark:bg-[#0D0D17] rounded-3xl shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className={`px-6 py-5 border-b border-gray-100 dark:border-[#2A2A3A] flex items-center justify-between bg-white dark:bg-[#0D0D17] z-10`}>
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${t.iconBg} ${t.iconColor}`}>
                  <Phone className="w-5 h-5" />
                </div>
                <div>
                  <h2 className="font-black text-gray-900 dark:text-gray-100 text-lg">Contact Details</h2>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest ml-1">Owner Number</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-gray-50 dark:bg-[#151522] border border-gray-200 dark:border-[#2A2A3A] rounded-xl focus:bg-white dark:bg-[#0D0D17] focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-semibold outline-none placeholder:font-medium"
                  />
                </div>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-widest ml-1">Delivery Boy Number (Optional)</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Phone className="w-4 h-4 text-gray-400" />
                  </div>

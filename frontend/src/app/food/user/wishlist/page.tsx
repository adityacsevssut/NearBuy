          ...
          <div>
            ...
            <div className="space-y-4">
              {foodWishlist.map((dish) => {
                ...
                <div
                  key={dish.id}
                  className={`relative bg-white dark:bg-[#0D0D17] p-4 rounded-2xl border border-gray-200 dark:border-[#2A2A3A] shadow-sm transition-all duration-300 flex gap-4 ${isDisabled ? "opacity-75 grayscale-[0.2]" : "hover:border-orange-300 hover:shadow-md"}`}
                >
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                      ...
                      <Link href={`/food/vendor/${dish.restaurantId}`} className="text-xs font-semibold text-gray-400 hover:text-orange-500 transition-colors mb-1 block">

    ...
    toast((t) => (
      <div className="flex flex-col gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-black text-gray-900 dark:text-gray-100 text-[15px]">Delete Service Center?</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-tight mt-0.5">
              Are you sure you want to delete this service center? This cannot be undone.
            </p>
          </div>
        </div>

...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://apis.google.com https://www.gstatic.com https://checkout.razorpay.com https://cdn.razorpay.com https://api.geoapify.com",
      "object-src 'none'",
      "base-uri 'self'",

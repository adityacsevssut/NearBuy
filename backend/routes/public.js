...
router.get("/vendors/:id/menu", async (req, res) => {
  try {
    ...
    const dummyFoods = [
      {
        id: `dummy-1-${req.params.id}`, category: "Main Course", name: "Special Veg Biryani",
        description: "Aromatic basmati rice cooked with fresh vegetables and secret spices.",
        price: 150, actual_price: 180, type: "veg", badge: "Bestseller",
        image_url: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=600&h=400", is_available: true,
        sort_order: 1, rating: 4.5, prep_time: "20 min", reviews: 120
      },
      {
        id: `dummy-2-${req.params.id}`, category: "Main Course", name: "Chicken Tikka Masala",
        description: "Tender chicken pieces cooked in a rich, creamy tomato gravy.",
        price: 250, actual_price: 280, type: "non-veg", badge: "Must Try",
        image_url: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=600&h=400", is_available: true,
        sort_order: 2, rating: 4.8, prep_time: "25 min", reviews: 200
      },
      {
        id: `dummy-3-${req.params.id}`, category: "Starters", name: "Paneer Tikka",
        description: "Marinated cottage cheese cubes grilled to perfection.",
        price: 180, actual_price: null, type: "veg", badge: "",
        image_url: "https://images.unsplash.com/photo-1599487405270-20120150d032?auto=format&fit=crop&w=600&h=400", is_available: true,
        sort_order: 3, rating: 4.2, prep_time: "15 min", reviews: 80
      },
      {
        id: `dummy-4-${req.params.id}`, category: "Desserts", name: "Chocolate Brownie",
        description: "Warm chocolate brownie served with vanilla ice cream.",
        price: 120, actual_price: 150, type: "veg", badge: "New",
        image_url: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=600&h=400", is_available: true,
        sort_order: 4, rating: 4.6, prep_time: "10 min", reviews: 150
      },
      {
        id: `dummy-5-${req.params.id}`, category: "Beverages", name: "Mango Lassi",
        description: "Refreshing yogurt-based mango drink.",
        price: 80, actual_price: null, type: "veg", badge: "",
        image_url: "https://images.unsplash.com/photo-1615486171448-4fd0d8e8a32a?auto=format&fit=crop&w=600&h=400", is_available: true,
        sort_order: 5, rating: 4.3, prep_time: "5 min", reviews: 90
      }
    ];

    return res.json({ items: [...rows, ...dummyFoods] });
  } catch (err) {
